...
export const Hero: React.FC = () => {
  ...
  return (
    <div className="relative w-full">
      {/* min-h-screen সরিয়ে নির্দিষ্ট ও কমপ্যাক্ট responsive min-h এবং padding ব্যবহার করা হয়েছে */}
      <section 
        ref={sectionRef} 
        className="relative w-full min-h-[580px] md:min-h-[680px] lg:min-h-[720px] bg-navy-950 overflow-hidden flex flex-col justify-between pb-16 md:pb-24"
      >
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 md:pt-32 lg:pt-36 pb-8 md:pb-16 flex-1 flex items-center">
          ...
          >
            <motion.div className="lg:col-span-12 mt-12 justify-center items-start space-y-4 md:space-y-5" variants={item}>
              ...
              <HeroSearch itemVariant={item} />
            </motion.div>
          </motion.div>
        </div>
      </section>

      {/* 3. Floating Stats Section */}
      <div className="relative z-20 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 -mt-22  ">
        <Stats />
      </div>
    </div>
  );
