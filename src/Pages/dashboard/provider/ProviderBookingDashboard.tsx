    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 border-b border-gray-200 dark:border-gray-800 pb-3">
        ...
        <div className="relative w-full sm:w-80">
          <Search className="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-navy-400" />
          <input
            type="text"
              ...
              <div className="bg-indigo-50/50 dark:bg-indigo-950/20 border border-indigo-100 dark:border-indigo-900/40 p-3.5 rounded-xl space-y-1">
                ...
                <div className="flex flex-wrap items-center gap-4 text-xs text-gray-600 dark:text-gray-300 pt-1">
                  <span className="flex items-center gap-1">
                    <Phone className="w-3 h-3 text-gray-400 dark:text-navy-400" /> {booking.phone}
                  </span>
                  <span className="flex items-center gap-1">
                    <Mail className="w-3 h-3 text-gray-400 dark:text-navy-400" /> {booking.email}
                  </span>
                </div>
              </div>
      ...
      {isModalOpen && selectedBooking && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-900 rounded-2xl max-w-md w-full p-6 shadow-xl space-y-4 relative max-h-[90vh] overflow-y-auto overscroll-contain">
            <button
