...
export const ServiceCard: React.FC<ServiceCardProps> = ({ 
  ...
  return (
    <article
      ...
      className="group cursor-pointer rounded-2xl bg-white dark:bg-navy-800 p-4 flex flex-col justify-between w-full h-full shadow-lg border border-neutral-200 transition-all duration-300 hover:-translate-y-2 hover:border-primary/50 hover:shadow-2xl dark:border-white/10"
    >
